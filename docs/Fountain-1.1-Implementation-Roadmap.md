...
| **Phase 15** | **Open:** SPM-only (**15.1**); **15.2–15.4** in progress (catalog, builder parity sweep, **4.6** note, **`FountainView`** + **`export-golden-minimal`** corpus checks, checklist / API-surface docs) — [§ Phase 15](#phase-15). |
