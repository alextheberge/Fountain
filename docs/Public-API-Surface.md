...
| **Fountain** | Re-exports Core + HTML for one import. Adds **umbrella-only** APIs that need both modules — e.g. ``FountainPDFWriter/renderPDFDataPaginated(script:)`` (``Sources/Fountain/FountainPDFPagination.swift``). |
