...
- **Phase 1 (SwiftPM + boundaries):** **Complete** — `Package.swift` defines **FountainCore** / **FountainHTML** / **Fountain**; CI uses **`swift build`** / **`swift test`**. Sample apps still compile **`Fountain/*.swift` inline** in Xcode (same paths as SPM, not a second codebase). Optional: link the local package from Xcode — [docs/Phase-1-Xcode-SPM-Integration.md](docs/Phase-1-Xcode-SPM-Integration.md). **Distribution:** [docs/Deprecation-And-Distribution.md](docs/Deprecation-And-Distribution.md).
